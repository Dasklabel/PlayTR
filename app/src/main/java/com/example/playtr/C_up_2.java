...
public class C_up_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_up_2);
            ...
            public void onClick(View view) {
                ...
                if(c_num < num) {
                    ...
                    if(c_data <= 0) {
                        ...
                        next.setText("   순찰대는 그 사이 우편물 가방을 챙겨 서둘러 길프레지로 향합니다.");
                        ok.setVisibility(View.VISIBLE);
                        ok.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view){
                                Intent intent = new Intent(C_up_2.this, Success_gill.class);
